...
available_datasets = {
    'METR-LA': partial(load_pems_data, rootpath='data/',
        name='METR-LA', adj_mx_name='adj_mx.pkl'),
    'METR-LA-onenode': partial(load_pems_data, rootpath='data/',
        name='METR-LA', adj_mx_name='adj_mx.pkl', one_node=True, one_sample=False),
    'METR-LA-onesample': partial(load_pems_data, rootpath='data/',
    ...
    'METR-LA-0.75': partial(load_pems_data, rootpath='data/',
        name='METR-LA', adj_mx_name='adj_mx.pkl', ratio=0.75),
    'METR-LA-0.05': partial(load_pems_data, rootpath='data/',
        name='METR-LA', adj_mx_name='adj_mx.pkl', ratio=0.05),
    'METR-LA-0.9': partial(load_pems_data, rootpath='data/',
        name='METR-LA', adj_mx_name='adj_mx.pkl', ratio=0.9),
    'PEMS-BAY': partial(load_pems_data, rootpath='data/',
        name='PEMS-BAY', adj_mx_name='adj_mx_bay.pkl'),
    'PEMS-BAY-0.25': partial(load_pems_data, rootpath='data/',
        name='PEMS-BAY', adj_mx_name='adj_mx_bay.pkl', ratio=0.25),
    'PEMS-BAY-0.5': partial(load_pems_data, rootpath='data/',
        name='PEMS-BAY', adj_mx_name='adj_mx_bay.pkl', ratio=0.5),
    'PEMS-BAY-0.75': partial(load_pems_data, rootpath='data/',
        name='PEMS-BAY', adj_mx_name='adj_mx_bay.pkl', ratio=0.75),
    'PEMS-BAY-0.05': partial(load_pems_data, rootpath='data/',
        name='PEMS-BAY', adj_mx_name='adj_mx_bay.pkl', ratio=0.05),
    'PEMS-BAY-0.9': partial(load_pems_data, rootpath='data/',
